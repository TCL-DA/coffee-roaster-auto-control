...
// uint16_t dAddress[200], dAddress_CP[200]; //40xxx HMI 
// uint8_t cAddress[200], cAddress_CP[200]; //Coils
// uint8_t progStatus = 0;
...
// #define TIME_DROP_MIN_SAVE      profileData[16]
...
// SimpleKalmanFilter diff_KalmanFilter(60, 60, 0.1);  //Kalman filter for Diff Air
...
// #define AUTO_FS_BTN_R_CP        dAddress_CP[AUTO_FS_BTN_W] //40030 - Auto fill silo
// #define AUTO_PID_AIR_TU_R_CP    dAddress_CP[AUTO_PID_AIR_TU_W] //40031 - Auto PID Air Tuning
...
SimpleKalmanFilter rorBTKalmanFilter(1, 1, 0.01); //Kalman filter for ror BT
SimpleKalmanFilter rorETKalmanFilter(1, 1, 0.01); //Kalman filter for ror BT and ET
SimpleKalmanFilter diff_KalmanFilter(70, 70, 0.2);  // mượt hơn, giữ mea_e
